...
if (db.getCollectionNames().includes("sales")) {
  console.log("sales collection exist");
} else {
  console.log("sales collection doesn't exist");
}

// reset the collection before creating one
